...
urlpatterns = [
    ...
    url(r'^edit-inform/', views.edit_inform),  # 修改个人信息
    url(r'^my-admin/', views.admin),  # 管理员登录
    ...
    url(r'^likes/',views.my_likes),
    url('favourite', views.handle, name='web_favourite_handle')
]
